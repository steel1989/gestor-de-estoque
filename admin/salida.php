...
if (confirm("Você realmente quer excluir esta saida?"))
...
$bd->consulta($sql);
                            ...
                            echo '<div class="alert alert-success alert-dismissable">
                                        ...
                                        <b>Bem!</b>Ótimo! Dados Excluidos Corretamente... ';
                    ...
                    echo "<br>";
                                ...
                                $bd->consulta($sql3);
                                            ...
                                            echo '<div class="alert alert-success alert-dismissable">
                                                        <i class="fa fa-check"></i>
                                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                        <b>Ótimo!</b> Excluido Corretamente... </div>';
                    }
        }
                                          ...
                                          if($salida=="")
                                            $salida=$precioactual;
                                                  //suma de cantidad actual mas la nueva
                                                   ...
                                                   if (is_numeric($grantotal) AND ($grantotal <0) ) {
                                                    echo "<h1>no ha estoque</h1>";
                                                     } 
                                             ...
                                             $sql="INSERT INTO `salida` (`id_salida`, `id_service_id_salida`, `fecha_salida`, `id_user_id_salida`, `sai_lt_id_litragem`, `cantida_salida`, `motivo_salida`) VALUES (NULL, '$service', '$resultado', '$user', '$conteudo', '$cantida', '$motivo')";
                                              $bd->consulta($sql);
                                                        ...
                                                        echo '<div class="alert alert-success alert-dismissable">
                                                                    <i class="fa fa-check"></i>
                                                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                                    <b>Ótimo!</b> Dados Cadastrados Corretamente... ';
                                                           echo '   </div>';
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          <a style=" margin-left: 10px;"  title="Registrar Nuevo" class="btn red btn-outline sbold " data-toggle="modal" href="#productoguarda">Nova Saida de estoque </a> 
                          <a style=" margin-left: 10px;" class="btn red btn-outline sbold " title="Atualizar tabla" data-toggle="modal" href="?admin=salida"> <i class="fa fa-refresh" aria-hidden="true"></i> </a> 

                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <i class="icon-arrow-up font-dark"></i>
                                        <span class="caption-subject bold uppercase">Registros das Saidas </span>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-phone-l">Data de Saida</th>
                                                <th class="min-phone-l">Motivo da Saida</th>
                                                <th class="min-phone-l"> Opções</th>
                                     ...
                                     $consulta="SELECT * FROM `salida` INNER JOIN service ON salida.id_service_id_salida=service.id_service 
                                       INNER JOIN litragem ON salida.sai_lt_id_litragem =litragem.id_litragem ";
                                         $bd->consulta($consulta);
                                      while ($fila=$bd->mostrar_registros()) { ?>
                                        <tr>    
                                        <?php $id= $fila->id_salida; ?>
                                             ...
                                             <td  width="10%"><?php echo $fila->cantida_salida; ?></td>
                                             <td width="15%"><?php echo $fila->fecha_salida; ?></td>
                                             <td  width="10%"><?php echo $fila->motivo_salida; ?>  </td>
              ...
              <div id="login-overlay" class="modal-dialog">
                <div class="modal-content">
                     <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
                          ...
                          <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;"><h4><i class="glyphicon glyphicon-upload"></i>&nbsp; Registrar Nova Salida.</h4></h2>
                      </div>
                                ...
                                <tbody>
                                 ...
                                 <thead>
                                  <tr>
                                                        ...
                                                        <th colspan="2">Motivo da saida</th>
