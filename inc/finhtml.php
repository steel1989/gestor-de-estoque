<!--footer-->
   <div style="background-color:#282828;" class="page-footer azul">
         <center>   <div class="page-footer-inner"> <?php echo  $hoy2 = date("Y"); ?> &copy; <?php echo $nameadmin ?>
                <a  title="Confira nosso trabalho" href="https://escolademarketers.online" target="_blank"><?php echo "escolademarketers.online"; ?>. ;)</a></center>
            </div>
