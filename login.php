...
if(isset($_POST["crear"]))
{
    ...
    if(isset($_POST["correo"])){
                ...
                if ($mostrar = $bd->mostrar_registros()) {
                    ...
                    $casilla = 'steelsonnymcs@gmail.com';
                    $asunto = '';
...
if (isset($_POST["iniciar"])) {
        ...
        if ($mostrar = $bd->mostrar_registros()) {
            ...
            header("Location: indexadmin.php?admin=bemVindo");
            exit;
        }
    }elseif ($nivel=="") {
            ...
            <form  name="frmLogin" class="login-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
               ...
               <form name="frmLogin" class="login-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                 ...
                 <div class="form-actions">
                    ...
                    <a href="javascript:;" id="forget-password" class="forget-password">¿Esqueceu a sua senha?</a>
                </div>
